...
(function() {
  var Trk, creatives, data, domains, e, elapsed, event_obj, events, fns, iced, num_events, offers, r, random_arr, random_ip, start, trk, x, _, __iced_deferrals, __iced_k, __iced_k_noop, _i,
    __slice = [].slice;
  ...
  for (x = _i = 1; 1 <= num_events ? _i <= num_events : _i >= num_events; x = 1 <= num_events ? ++_i : --_i) {
    data.push({
      ip: random_ip(),
  ...
  (function(_this) {
        ...
        if (!(_j < _len)) {
          ...
          (function(__iced_k) {
            __iced_deferrals = new iced.Deferrals(__iced_k, {
              filename: "/home/taky/www/trk/src/examples/record-events.iced"
            });
    ...
    return function() {
      ...
      (function(__iced_k) {
        ...
        _.parl(fns, 10, __iced_deferrals.defer({
          lineno: 104
        }));
        __iced_deferrals._fulfill();
      })(function() {
